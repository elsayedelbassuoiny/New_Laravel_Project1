  ...
  <body>
    ...
    @method('PUT')
        ...
        <div class="form-group">
          ...
          <input type="text" id="code" name="email" value="{{$students->email}}"required>
        </div>
        <div class="form-group">
            <label for="code">Password:</label>
            <input type="text" id="code" name="password" value="{{$students->password}}"required>
          </div>
          <div class="form-group">
            <label for="code">level:</label>
            <input type="text" id="code" name="level" value="{{$students->level}}"required>
          </div>
          <div class="form-group">
            <label for="code">Acadimic Number:</label>
            <input type="text" id="code" name="acadimic_number" value="{{$students->acadimic_number}}"required>
          </div>
          <div class="form-group">
