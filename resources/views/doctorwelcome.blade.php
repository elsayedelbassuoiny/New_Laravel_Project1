        ...
        <nav class="navbar header-nav navbar-expand-lg">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav">
                        <li><a class="nav-link active" href="/doctorwelcome">Home</a></li>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="slide_text">
                                        <h3><span span class="theme_color">Faculty of Computers and Informations FCI</span><br>FCI-Student Management System</h3>
                                        <h4>Welcome</h4>
                                        <br>
                                        <div class="full center">
										    <a class="contact_bt" href="courses.html">Start</a>
										</div>
                                    </div>
                                </div>
                            </div>
	   ...
	   <div class="container">
	      <div class="row">
		      <div class="col-md-12">
			     <div class="tab_menu">
				    <ul>
					   <li><a href="#"><span class="icon"><img src="{{asset('images/i1.png')}}" alt="#" /></span><span>University Life</span></a></li>
