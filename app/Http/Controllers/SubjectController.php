...
class SubjectController extends Controller
{
    ...
    public function create_file($id)
    {
        ...
        return view('subjects.files.create')->with($data);
    }

    public function store_file(Request $request, string $subjectId)
    {
        ...
        $file->move('files', $uploadName);

        $files = json_decode($subject->files);
        array_push($files, $uploadName);
